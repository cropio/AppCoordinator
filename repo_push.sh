...
sed -i ".bak" "s/s.version          = .*/s.version          = '"$version"'/" AppCoordinator.podspec
...
pod repo push cropio-specs AppCoordinator.podspec --allow-warnings

# Back to primary
git checkout AppCoordinator.podspec
